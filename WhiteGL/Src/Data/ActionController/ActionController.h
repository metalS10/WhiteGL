...
public:
	...
	*@param	速度
	*/
	CActionMoveStraight(cocos2d::Point basePos, float vel);

	CActionMoveStraight(cocos2d::Point basePos, float velX,float velY);
...
public:
	...
	*@param	速度
	*/
	CActionCurve(cocos2d::Point basePos, float vel);

	CActionCurve(cocos2d::Point basePos, float velX, float velY);
