...
public:
	...
	*@param	基準点
	*/
	virtual void collision(CCharacter* pChara,CCharacter* pSelf, cocos2d::Point basePt) = 0;
...
public:
	...
	*@param	基準点
	*/
	virtual void collision(CCharacter* pChara,CCharacter* pSelf, cocos2d::Point basePt) override {}
...
public:
	...
	{
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::BOTTOM, cocos2d::Point(0,pBody->m_bottom)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::TOP, cocos2d::Point(0, pBody->m_top)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::RIGHT, cocos2d::Point(pBody->m_right,0)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::LEFT, cocos2d::Point(pBody->m_left,0)));
	}
	//デストラクタ
	~CCollisionAreaEndOfScreen(){}
...
public:
	...
	CCollisionAreaMap(CBody* pBody)
	{
		...
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::BOTTOM, cocos2d::Point(pBody->m_left*0.5, pBody->m_bottom)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::BOTTOM, cocos2d::Point(pBody->m_right*0.5, pBody->m_bottom)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::TOP, cocos2d::Point(pBody->m_left*0.5, pBody->m_top)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::TOP, cocos2d::Point(pBody->m_right*0.5, pBody->m_top)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::RIGHT, cocos2d::Point(pBody->m_right, pBody->m_top*0.5)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::RIGHT, cocos2d::Point(pBody->m_right, pBody->m_bottom*0.5)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::LEFT, cocos2d::Point(pBody->m_left, pBody->m_top*0.5)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::LEFT, cocos2d::Point(pBody->m_left, pBody->m_bottom*0.5)));
	}
	//デストラクタ
	~CCollisionAreaMap(){}
...
public:
	...
	CCollisionAreaCharacter(CBody* pBody)
	{
		...
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::BOTTOM, cocos2d::Point(pBody->m_left*0.5, pBody->m_bottom)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::BOTTOM, cocos2d::Point(pBody->m_right*0.5, pBody->m_bottom)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::BOTTOM, cocos2d::Point(pBody->m_left*0.25, pBody->m_bottom)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::BOTTOM, cocos2d::Point(pBody->m_right*0.25, pBody->m_bottom)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::TOP, cocos2d::Point(pBody->m_left*0.5, pBody->m_top)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::TOP, cocos2d::Point(pBody->m_right*0.5, pBody->m_top)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::RIGHT, cocos2d::Point(pBody->m_right, pBody->m_top*0.5)));
		this->m_pBasePoints->push_back(new CCollisionBasePoint(TERRITORY_TYPE::RIGHT, cocos2d::Point(pBody->m_right, pBody->m_bottom*0.5)));
